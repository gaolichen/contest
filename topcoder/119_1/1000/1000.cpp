...
public:
	i64 ret;
	int cap[30];
	void dfs(string num,int k,int ans){
	}
...
void test0(){
	...
	string convert= "14";
	RomanNum _RomanNum;
	string ret=_RomanNum.convert(number);
	cout<<"--------------------test 0--------------------"<<endl;
	cout<<"number = "<<number<<endl;
	cout<<"expected to return "<<convert<<endl;
...
void test3(){
	string number="ABCADEDFFGGGHGYXOP";
	string convert= "491923944";
	RomanNum _RomanNum;
	string ret=_RomanNum.convert(number);
	cout<<"--------------------test 3--------------------"<<endl;
	cout<<"number = "<<number<<endl;
